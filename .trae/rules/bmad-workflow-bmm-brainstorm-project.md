# brainstorm-project Workflow Rule

This rule defines the brainstorm-project workflow.
...
Reference this workflow with `@workflow-brainstorm-project` to execute the guided workflow.
